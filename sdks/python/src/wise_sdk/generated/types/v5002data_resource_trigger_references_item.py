...
class V5002DataResourceTriggerReferencesItem(UniversalBaseModel):
    type: typing.Optional[V5002DataResourceTriggerReferencesItemType] = pydantic.Field(default=None)
    """
