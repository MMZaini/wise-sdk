...
class V20017DataResourceTriggerReferencesItem(UniversalBaseModel):
    type: typing.Optional[V20017DataResourceTriggerReferencesItemType] = pydantic.Field(default=None)
    """
