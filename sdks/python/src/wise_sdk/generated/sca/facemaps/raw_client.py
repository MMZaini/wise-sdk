...
class RawFacemapsClient:
    ...
    def create(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"profiles/{quote_path_param(profile_id)}/facemaps",
    ...
    def delete(self, *, profile_id: int, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[None]:
        """
    ...
    def verify(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"profiles/{quote_path_param(profile_id)}/facemaps/verify",
            base_url=self._client_wrapper.get_environment().api,
            method="POST",
            json={
                "faceMap": face_map,
