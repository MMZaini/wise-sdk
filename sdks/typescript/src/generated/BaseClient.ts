...
export type AuthOption =
    ...
    | core.AuthProvider
    | AnyAuthProvider.AuthOptions<[BearerAuthProvider.AuthOptions, BasicAuthProvider.AuthOptions]>;

export type BaseClientOptions = {
    environment: core.Supplier<environments.WiseEnvironment | environments.WiseEnvironmentUrls>;
    /** Specify a custom URL to connect the client to. */
    baseUrl?: core.Supplier<string>;
    /** Override the X-External-Correlation-Id header */
    externalCorrelationId?: core.Supplier<string | undefined>;
    ...
    const headers = mergeHeaders(
        {
            ...
            "X-External-Correlation-Id": options?.externalCorrelationId,
        },
        options?.headers,
    );
