 ...
 *     }
 */
export interface ClearCardTransactionSimulationsRequest {
    /** The profile ID. */
    profileId: number | bigint;
    /** The card token. */
    cardToken: string;
    amount?: ClearCardTransactionSimulationsRequest.Amount;
...
export namespace ClearCardTransactionSimulationsRequest {
